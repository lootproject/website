export const project_data = {
  ...
  "Genesis Adventurer": {
    name: "A Genesis Adventurer",
    description: "Resurrect a Genesis Adventurer.",
    whatToDo: [
      {
        content: "Resurrect",
  ...
  "mloot": {
    name: "mloot",
    description: "mLoot is more loot. 1.5 million loot bags with 250,000 more per year. They are free to claim.",
    whatToDo: [
      {
        content: "Trade on Open Sea",
  ...
  "NFTx": {
    name: "NFTx",
    description: "Shop and earn yield on the most liquid decentralized NFT marketplace.",
    whatToDo: [
      {
        content: "Trade NFTs",
        url: "https://nftx.io/"
  ...
  "Stake a Realm": {
    name: "Stake a Realm",
    description: "Stake your Realm & Generate resources to trade and battle with.",
    whatToDo: [
      {
  ...
  "Synthetic Loot": {
    name: "Synthetic Loot",
    tag: "sloot",
    description: "There are 2^160 potential different sLoot bags. View them in the browser.",
    whatToDo: [
      {
...
export const whatToGet = [
  {
    ...
    description: "",
    project: [
      project_data["Loot (for Adventurers)"],
      project_data["Synthetic Loot"],
      project_data["mloot"],
    ],
  },
  {
    ...
    description: "",
    project: [
      project_data["Adventure Gold $AGLD"],
      project_data["Realms"],
      project_data["The Genesis Project"],
      project_data["Loot Mart"],
      project_data["Loot Character"],
    ],
  },
];
...
export const whatToDo = [
  {
    ...
    project: [
      project_data["Loot Mart"],
      project_data["Genesis Adventurer"],
      project_data["Stake a Realm"],
    ],
  },
];
...
export const marketPlaces = [
  {
    ...
    project: [
      project_data["Loot Mart"],
      project_data["Loot Exchange"],
      project_data["Open Sea"],
      project_data["NFTx"],
    ],
  },
];
