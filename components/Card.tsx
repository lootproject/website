...
export function Card(props: any) {
  return (
    <div className="bg-gray-900 rounded-xl p-5 sm:p-8 w-full md:w-1/4 sm:w-1/2 shadow-xl my-3 mx-3 transform hover:-translate-y-2 hover:border-white border border-black duration-150 ">
